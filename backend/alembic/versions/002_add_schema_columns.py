...
def upgrade() -> None:
    # -- mcp_servers ----------------------------------------------------------
    if not _has_column("mcp_servers", "proxy_url"):
        op.add_column(
            "mcp_servers",
    ...
    if not _has_column("agents", "project_path"):
        op.add_column(
            "agents",
            sa.Column("project_path", sa.Text, nullable=True),
        )
    if not _has_column("agents", "model"):
        op.add_column(
            "agents",
            sa.Column(
                "model",
    ...
    if not _has_column("agents", "system_prompt"):
        op.add_column(
            "agents",
            sa.Column("system_prompt", sa.Text, nullable=True),
        )
    if not _has_column("agents", "permission_mode"):
        op.add_column(
            "agents",
            sa.Column(
                "permission_mode",
    ...
    if not _has_column("agents", "lightning_config"):
        op.add_column(
            "agents",
            sa.Column("lightning_config", JSONB, server_default="{}", nullable=True),
        )
    if not _has_column("agents", "runtime"):
        op.add_column(
            "agents",
            sa.Column(
                "runtime",
    ...
    # -- skills ---------------------------------------------------------------
    if not _has_column("skills", "skill_path"):
        op.add_column(
            "skills",
    ...
    # -- infra_agents ---------------------------------------------------------
    if not _has_column("infra_agents", "agent_id"):
        op.add_column(
            "infra_agents",
            sa.Column(
                "agent_id",
    ...
    if not _has_column("infra_agents", "role"):
        op.add_column(
            "infra_agents",
            sa.Column("role", sa.String(50), server_default="primary", nullable=True),
        )
    if not _has_column("infra_agents", "port_override"):
        op.add_column(
            "infra_agents",
            sa.Column("port_override", sa.Integer, nullable=True),
        )
    if not _has_column("infra_agents", "env_overrides"):
        op.add_column(
            "infra_agents",
    ...
    if not _has_column("infrastructures", "lightning_config"):
        op.add_column(
            "infrastructures",
            sa.Column("lightning_config", JSONB, server_default="{}", nullable=True),
        )
    ...
    if not _has_column("infrastructures", "type"):
        op.add_column(
            "infrastructures",
            sa.Column(
                "type",
